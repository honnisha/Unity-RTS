...
SubShader {
	Pass {
		...
		float4 frag(v2f i) : COLOR{
			...
			// Saturation/Lum of underlay:
			float3 satLum=RGBtoHSL(_0.rgb);
			
			// Hue of the top:
			float hue=RGBtoHSL(_1.rgb)[0];
			
			// Combine:
			_1.rgb=HSLtoRGB(float3(hue,satLum[1],satLum[2]));
